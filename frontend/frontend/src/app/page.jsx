...
const App = () => {
    ...
    const categories = [
    { id: 1, name: "Tractors", image: "tractor.jpg" },
    ...
    <div className="font-sans">
      {/* Hero Section */}
        <div className="bg-cover bg-center h-screen" style={{ backgroundImage: "url('/hero.jpg')" }}>
        <div className="flex flex-col items-center justify-center h-full bg-black bg-opacity-50 text-white text-center">
            ...
            <button className="px-6 py-2 bg-green-600 rounded-lg hover:bg-green-500">Browse Equipment</button>
            <button className="px-6 py-2 bg-blue-600 rounded-lg hover:bg-blue-500">Get a Quote</button>
            </div>
        </div>
        </div>
      ...
      {/* <footer className="p-6 bg-gray-800 text-white text-center">
        <p>&copy; 2024 Agriculture Rentals. All rights reserved.</p>
      </footer> */}
    </div>
  );
};
